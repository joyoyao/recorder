...
#ifndef OPENAMEDIA_META_DATA_H
#define OPENAMEDIA_META_DATA_H
...
namespace ARecoder {
	...
	enum {
		kKeyMediaType = 'mdtp', //int32(enum MediaType): MEDIA_TYPE_AUDIO/MEDIA_TYPE_VIDEO
		kKeyHasAudio = 'hsad', //int32(bool)
		kKeyHasVideo = 'hsvd', //int32(bool)
		kKeyBitsPerSample = 'bpsp', //int32.
		kKeyAudioEncodeBufSize = 'aebs', //int32
	};
