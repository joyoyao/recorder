...
//    private NewFFmpegFrameRecorder mVideoRecorder;
    ...
    private RecorderActivity.AsyncStopRecording mAsyncTask;
    ...
    public RecorderThread(int size,int frame){
...
//                    }
    ...
    public void stopRecord(AsyncTask asyncTask){
        mAsyncTask = (RecorderActivity.AsyncStopRecording)asyncTask;
        M_IS_STOP.set(true);
        try {
            this.join();
        } catch (Exception e) {
